       ...
       while ( steps < chicloVrach):
           ...
           while (True):
               ...
               if p_cntr_1 == p_cntr_2:
                   ...
                   key1 = chislo_of # создать проверку соответствует ли число шагу игры
                   print('key1:', key1)
                   if (winer_1 != 99) or ((sttepers > 1) and (sttepers < 54)) :  # если предсказания нет то и играть не будем
                       sttepers = sttepers + 1

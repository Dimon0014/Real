...
class MyFrame(wx.Frame):
    ...
    def OnButton(self, event):
        ...
        f = self.coordWindow('coordscanvhod')
        ...
        with open('coord_snapshot_vhoda2.txt', 'w') as jsonfile: json.dump(coordinaty_snap, jsonfile)  # сохраняем в файл
...
class MyApp(wx.App):
    def OnInit(self):
        frame = MyFrame(None, -1, 'CoordScanVhod')
        frame.Show(True)

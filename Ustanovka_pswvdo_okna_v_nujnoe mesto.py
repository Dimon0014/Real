...
class MyForm(wx.Frame):
    def __init__(self):
        ...
        self.posCtrl = wx.TextCtrl(panel, -1, "no resize", pos=(100, 10),size=(350,20) )  # создаем атрибут - окно Edit - текстовое
    ...
    def onPlacewindow(self, event):
        ...
        if btn == 'Get Place Window':
           ...
           print('place', place)
           with open('WindowPlace2_.txt', 'w') as jsonfile: json.dump(place, jsonfile)
